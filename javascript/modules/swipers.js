		...
		swiper = new Swiper(swiperTarget, {
			...
			on: {
				init: function () {
					...
					const activeSlideIndex = swiperActiveSlideIndex(
						this,
						'[data-nav-link]',
						'is-current'
					);
					const isActiveVisible = swiperIsSlideVisible(
						this,
						activeSlideIndex
					);
					console.log(`activeSlideIndex: ${activeSlideIndex}`);
					console.log(`isActiveVisible: ${isActiveVisible}`);

					if (!isActiveVisible) {
						this.slideTo(activeSlideIndex - (visibleCount - 1));
					}
				},
