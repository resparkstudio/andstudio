...
<div data-nav-slider="container" class="relative flex items-center grow -ml-1.5">
    <div data-nav-slider="wrap" class="pl-9.5 pr-8 flex gap-6 items-center absolute left-0 bg-neutral-grey-1 h-full rounded-r-lg">
        <button class="swiper-button-prev hidden text-neutral-black">
        ...
        <div data-swiper="navigation" class="overflow-hidden">
        ...
        <button class="swiper-button-next hidden text-neutral-black">
            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
