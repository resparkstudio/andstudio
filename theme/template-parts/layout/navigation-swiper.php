...
<div data-nav-slider="target" class="relative flex items-center grow -ml-1.5">
    <div data-nav-slider="container" class="pl-9.5 pr-8 flex gap-6 items-center absolute left-0 bg-neutral-grey-1 h-full rounded-r-lg">
        ...
        <div data-nav-slider="wrap" class="overflow-auto no-scrollbar flex gap-8">
            <?php foreach ($sibling_pages as $page) : ?>
                <div data-nav-slider="item" class="shrink-0">
