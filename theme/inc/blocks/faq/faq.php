...
<section class="bg-neutral-grey-1 min-h-screen pb-12 md:pb-23" x-data='{"expanded": null}'>
    <?php if ($mobile_image) : ?>
                                ...
                                <div class="flex flex-col gap-2.5 md:gap-4">
                                    ...
                                    ?>
                                        <div class="rounded-xl transition-colors duration-200"
                                            :class="expanded === '<?php echo esc_attr($unique_id) ?>' ? 'bg-brand-secondary text-text-secondary' : 'bg-neutral-grey-1'">
                                            <!-- Trigger -->
                                            <button @click="expanded = expanded === '<?php echo esc_attr($unique_id) ?>' ? null : '<?php echo esc_attr($unique_id) ?>'"
                                                ...
                                                <?php endif ?>
                                                <div class="shrink-0 rounded-full relative w-7 h-7 flex items-center justify-center bg-brand-primary text-text-primary">
                                            ...
                                            <!-- Expand -->
                                            <div x-show="expanded === '<?php echo esc_attr($unique_id) ?>'" x-collapse.duration.400ms>
